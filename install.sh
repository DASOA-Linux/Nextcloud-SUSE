...
zypper install -y apache2 apache2-mod_php8 mariadb mariadb-client php8 php8-mysql php8-openssl php8-xmlreader php8-xmlwriter php8-mbstring php8-gd php8-fileinfo php8-zip php8-dom php8-curl php8-zlib php8-ctype php8-pdo php8-mysql
...
# Ejecutar el instalador de Nextcloud desde la línea de comandos
php /srv/www/htdocs/nextcloud/occ maintenance:install --database "mysql" --database-name "nextcloud" --database-user "Admin" --database-pass "dasoalinux" --admin-user "Admin" --admin-pass "dasoalinux"
